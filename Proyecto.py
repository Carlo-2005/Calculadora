...
notebook.add(frame3, text='Separadores')
...
separador_horizontal = ttk.Separator(frame3, orient="horizontal")
separador_horizontal.pack(fill='x', padx=10, pady=10)
label1 = tk.Label(frame3, text="Mirame estoy enmedio de los separadores :)")
label1.pack()

separador_h2 = ttk.Separator(frame3, orient="horizontal")
separador_vertical = ttk.Separator(frame3, orient="vertical")

#empaquetamos los separadores

separador_h2.pack(fill="x", padx=10, pady=10)
separador_vertical.pack(side="left", fill="y", padx=10, pady=10)

#creamos etiquetas para los separadores

label2 = tk.Label(frame3, text="Estoy debajo del separador :o")
label3 = tk.Label(frame3, text="Estoy al lado del separador")
...
imagen = Image.open("Equipo.jpg")  # Cambia "Equipo.png" por la imagen que quieras usar
...
integrantes = [
    ...
    {"nombre": "Juan Carlos Pineda Soriano", "matricula": "231403048", "numero_lista": "18"},
